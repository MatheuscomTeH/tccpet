...
<main class="centralizar">
	<div class="container center-v">
		...
		<div class="card border-light mb-3">
			<div class="card-header">Listagem de Cliente</div>
					...
					<tbody>
						...
						<c:forEach var="cliente"  items="${clientes}">
							<tr>
								...
								<td>
									<!-- Exibir --> <a
									href="<c:url value="/funcionario/exibe-cliente?id=${cliente.id}"/>"
									class="btn btn-info btn-sm" data-toggle="tooltip"
									data-bs-placement="bottom" title="Exibir"> <i
											class="bi bi-eye"></i>
								</a> <!-- Editar --> <a
									href="<c:url value="/funcionario/edita-cliente?id=${cliente.id}" />"
									...
									<button type="button" class="btn btn-danger btn-sm"
										...
										data-bs-target="#modal${cliente.id}">
										...
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-footer">
													<a href="<c:url value="/funcionario/remove-cliente?id=${cliente.id}" />"
		...
		<div align="center">
			<a href="<c:url value="/funcionario/novo-cliente" />"
