...
<head>
  ...
  <!-- Adicione isso ao cabeçalho do seu HTML para incluir o Bootstrap -->
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.16.0/umd/popper.min.js"></script>
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script>
<link href="agendamentojava.js" rel="agendamentojava">
          ...
          <div class="" id="">
            ...
            <div id="myNav" class="overlay">
              <div class="overlay-content">
                ...
                <a href="contact.html">Cadastro</a>
...
<!-- Seu formulário -->
<form action="cadastro_cliente.php" method="POST" id="formCadastro">
  <div>
    <input type="text" name="nome" placeholder="Digite seu nome" maxlength="45" required/>
  </div>
  <div>
    <input type="tel" name="telefone" placeholder="Número para contato" pattern="[0-9]+" title="Somente números são permitidos" maxlength="11" required/>          
  </div>
  <div>
