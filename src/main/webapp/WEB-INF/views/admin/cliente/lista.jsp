...
<main>
	<div class="container center-v">
					...
					<tbody>
						...
						<c:forEach var="cliente"  items="${clientes}">
							<tr>
								...
								<td>
									<!-- Exibir --> <a
									href="<c:url value="/admin/exibe-cliente?id=${cliente.id}"/>"
									class="btn btn-info btn-sm" data-toggle="tooltip"
									data-bs-placement="bottom" title="Exibir"> <i
											class="bi bi-eye"></i>
								</a> <!-- Editar --> <a
									href="<c:url value="/admin/edita-cliente?id=${cliente.id}" />"
										...
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-footer">
													<a href="<c:url value="/admin/remove-cliente?id=${cliente.id}" />"
		...
		<div align="center">
			<a href="<c:url value="/admin/novo-cliente" />"
