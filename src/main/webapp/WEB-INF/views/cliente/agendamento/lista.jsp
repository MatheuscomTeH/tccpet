...
<body>
	...
	<main class="centralizar">
		<div class="container center-v">
						...
						<tbody>
							...
							<c:forEach var="agendamento" items="${agendamentos}">
								<tr>
									...
									<td><a href="exibe-agendamento?id=${agendamento.id}"
										class="btn btn-info btn-sm" data-toggle="tooltip"
										data-bs-placement="bottom" title="Exibir"> <i
											class="bi bi-eye"></i>
									</a> <!-- Editar --> <a
										href="<c:url value="edita-agendamento?id=${agendamento.id}" />"
										...
										<div class="modal fade" id="modal${agendamento.id}"
											tabindex="-1">
											<div class="modal-dialog" role="document">
												<div class="modal-content">
													...
													<div class="modal-body">
														<p>
															Deseja realmente excluir o Agendamento <br>ID
															(${agendamento.id}) ?
														</p>
													</div>
			...
			<div align="center">
				<a href="<c:url value="/cliente/index" />"
