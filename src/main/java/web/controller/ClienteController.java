...
import web.model.ConversorDataHora;
...
public class ClienteController {
    ...
    public String adicionaAgendamento(@Valid Agendamento agendamento,BindingResult result,String dataa,String horaa) {
    	System.out.println(result);
    	if(result.hasErrors()) {
    	  return	"redirect:index";
    	}
    	
    	agendamento.setData(ConversorDataHora.converterStringParaData(dataa));
    	agendamento.setHora(ConversorDataHora.converterStringParaHora(horaa));
